...
export const WhoWeAre = () => {
	return (
		<div className='space-y-16 sm:space-y-20'>
			<PageSEO
				title='Who We Are'
				description='Learn about RCCG Psalms & Hymns Parish — our story, mission, vision, core values, and what we believe. A Bible-believing, Spirit-led Pentecostal church in Cobridge, Stoke-on-Trent.'
				path='/who-we-are'
				keywords='who we are RCCG Psalms Hymns, church story Stoke-on-Trent, mission vision Christian church Cobridge, what we believe Pentecostal church, Redeemed Christian Church of God beliefs'
			/>
				...
				<div className='grid gap-4 sm:grid-cols-2 lg:grid-cols-5'>
					{values.map((v, i) => (
						...
						>
							...
							<h3 className='mt-3 text-base font-bold text-slate-900'>{v.label}</h3>
